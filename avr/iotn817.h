...
#define CLKCTRL_PDIV_gm 0x1E      /* Prescaler divition group mask. */
#define CLKCTRL_PDIV_gp 1         /* Prescaler divition group position. */
#define CLKCTRL_PDIV0_bm (1 << 1) /* Prescaler divition bit 0 mask. */
#define CLKCTRL_PDIV0_bp 1        /* Prescaler divition bit 0 position. */
#define CLKCTRL_PDIV1_bm (1 << 2) /* Prescaler divition bit 1 mask. */
#define CLKCTRL_PDIV1_bp 2        /* Prescaler divition bit 1 position. */
#define CLKCTRL_PDIV2_bm (1 << 3) /* Prescaler divition bit 2 mask. */
#define CLKCTRL_PDIV2_bp 3        /* Prescaler divition bit 2 position. */
#define CLKCTRL_PDIV3_bm (1 << 4) /* Prescaler divition bit 3 mask. */
#define CLKCTRL_PDIV3_bp 4        /* Prescaler divition bit 3 position. */
