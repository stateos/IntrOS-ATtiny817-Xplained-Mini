...
typedef enum ADC_REFSEL_enum
{
    ...
    ADC_REFSEL_AREF_gc = (0x02<<4),  /* Internal analog reference */
} ADC_REFSEL_t;
...
{
    BOD_ACTIVE_OFF_gc = (0x00<<2),  /* Disabled */
...
{
    BOD_SLEEP_OFF_gc = (0x00<<0),  /* Disabled */
...
typedef struct EVSYS_struct
{
    ...
    register8_t ASYNCUSER12;  /* Asynchronous User Ch 12 Input Selection - ADC0 */
    register8_t reserved_0x1F;
    register8_t reserved_0x20;
    register8_t reserved_0x21;
...
{
    LVL_1V8_gc = (0x00<<5),  /* 1.8 V */
    LVL_2V15_gc = (0x01<<5),  /* 2.15 V */
    LVL_2V51_gc = (0x02<<5),  /* 2.51 V */
    LVL_2V87_gc = (0x03<<5),  /* 2.87 V */
    LVL_3V94_gc = (0x06<<5),  /* 3.94 V */
    LVL_4V3_gc = (0x07<<5),  /* 4.3 V */
} LVL_t;
...
/* ADC0 referance select select */
typedef enum VREF_ADC0REFSEL_enum
{
    VREF_ADC0REFSEL_0V55_gc = (0x00<<4),  /* Voltage referance at 0.55V */
    VREF_ADC0REFSEL_1V1_gc = (0x01<<4),  /* Voltage referance at 1.1V */
    VREF_ADC0REFSEL_2V5_gc = (0x02<<4),  /* Voltage referance at 2.5V */
    VREF_ADC0REFSEL_4V34_gc = (0x03<<4),  /* Voltage referance at 4.34V */
    VREF_ADC0REFSEL_1V5_gc = (0x04<<4),  /* Voltage referance at 1.5V */
} VREF_ADC0REFSEL_t;

/* ADC1 reference select select */
typedef enum VREF_ADC1REFSEL_enum
{
    VREF_ADC1REFSEL_0V55_gc = (0x00<<4),  /* Voltage referance at 0.55V */
    VREF_ADC1REFSEL_1V1_gc = (0x01<<4),  /* Voltage referance at 1.1V */
    VREF_ADC1REFSEL_2V5_gc = (0x02<<4),  /* Voltage referance at 2.5V */
    VREF_ADC1REFSEL_4V34_gc = (0x03<<4),  /* Voltage referance at 4.34V */
    VREF_ADC1REFSEL_1V5_gc = (0x04<<4),  /* Voltage referance at 1.5V */
} VREF_ADC1REFSEL_t;

/* DAC0/AC0 referance select select */
typedef enum VREF_DAC0REFSEL_enum
{
    VREF_DAC0REFSEL_0V55_gc = (0x00<<0),  /* Voltage referance at 0.55V */
    VREF_DAC0REFSEL_1V1_gc = (0x01<<0),  /* Voltage referance at 1.1V */
    VREF_DAC0REFSEL_2V5_gc = (0x02<<0),  /* Voltage referance at 2.5V */
    VREF_DAC0REFSEL_4V34_gc = (0x03<<0),  /* Voltage referance at 4.34V */
    VREF_DAC0REFSEL_1V5_gc = (0x04<<0),  /* Voltage referance at 1.5V */
} VREF_DAC0REFSEL_t;

/* DAC1/AC1 reference select select */
typedef enum VREF_DAC1REFSEL_enum
{
    VREF_DAC1REFSEL_0V55_gc = (0x00<<0),  /* Voltage referance at 0.55V */
    VREF_DAC1REFSEL_1V1_gc = (0x01<<0),  /* Voltage referance at 1.1V */
    VREF_DAC1REFSEL_2V5_gc = (0x02<<0),  /* Voltage referance at 2.5V */
    VREF_DAC1REFSEL_4V34_gc = (0x03<<0),  /* Voltage referance at 4.34V */
    VREF_DAC1REFSEL_1V5_gc = (0x04<<0),  /* Voltage referance at 1.5V */
} VREF_DAC1REFSEL_t;

/* DAC2/AC2 reference select select */
typedef enum VREF_DAC2REFSEL_enum
{
    VREF_DAC2REFSEL_0V55_gc = (0x00<<0),  /* Voltage referance at 0.55V */
    VREF_DAC2REFSEL_1V1_gc = (0x01<<0),  /* Voltage referance at 1.1V */
    VREF_DAC2REFSEL_2V5_gc = (0x02<<0),  /* Voltage referance at 2.5V */
    VREF_DAC2REFSEL_4V34_gc = (0x03<<0),  /* Voltage referance at 4.34V */
    VREF_DAC2REFSEL_1V5_gc = (0x04<<0),  /* Voltage referance at 1.5V */
} VREF_DAC2REFSEL_t;
...
#define CCL_LUTEN_bm  0x01  /* LUT Enable bit mask. */
#define CCL_LUTEN_bp  0  /* LUT Enable bit position. */
...
#define PORTMUX_USART0_bm  0x01  /* Port Multiplexor USART0 bit mask. */
#define PORTMUX_USART0_bp  0  /* Port Multiplexor USART0 bit position. */
#define PORTMUX_SPI0_bm  0x04  /* Port Multiplexor SPI0 bit mask. */
#define PORTMUX_SPI0_bp  2  /* Port Multiplexor SPI0 bit position. */
#define PORTMUX_TWI0_bm  0x10  /* Port Multiplexor TWI0 bit mask. */
#define PORTMUX_TWI0_bp  4  /* Port Multiplexor TWI0 bit position. */

/* PORTMUX.CTRLC  bit masks and bit positions */
#define PORTMUX_TCA00_bm  0x01  /* Port Multiplexor TCA0 Output 0 bit mask. */
#define PORTMUX_TCA00_bp  0  /* Port Multiplexor TCA0 Output 0 bit position. */
#define PORTMUX_TCA01_bm  0x02  /* Port Multiplexor TCA0 output 1 bit mask. */
#define PORTMUX_TCA01_bp  1  /* Port Multiplexor TCA0 output 1 bit position. */
#define PORTMUX_TCA02_bm  0x04  /* Port Multiplexor TCA0 Output 2 bit mask. */
#define PORTMUX_TCA02_bp  2  /* Port Multiplexor TCA0 Output 2 bit position. */
#define PORTMUX_TCA03_bm  0x08  /* Port Multiplexor TCA0 Output 3 bit mask. */
#define PORTMUX_TCA03_bp  3  /* Port Multiplexor TCA0 Output 3 bit position. */
#define PORTMUX_TCA04_bm  0x10  /* Port Multiplexor TCA0 Output 4 bit mask. */
#define PORTMUX_TCA04_bp  4  /* Port Multiplexor TCA0 Output 4 bit position. */
#define PORTMUX_TCA05_bm  0x20  /* Port Multiplexor TCA0 Output 5 bit mask. */
#define PORTMUX_TCA05_bp  5  /* Port Multiplexor TCA0 Output 5 bit position. */

/* PORTMUX.CTRLD  bit masks and bit positions */
#define PORTMUX_TCB0_bm  0x01  /* Port Multiplexor TCB bit mask. */
#define PORTMUX_TCB0_bp  0  /* Port Multiplexor TCB bit position. */
...
#define VREF_DAC0REFSEL_gm  0x07  /* DAC0/AC0 referance select group mask. */
#define VREF_DAC0REFSEL_gp  0  /* DAC0/AC0 referance select group position. */
#define VREF_DAC0REFSEL0_bm  (1<<0)  /* DAC0/AC0 referance select bit 0 mask. */
#define VREF_DAC0REFSEL0_bp  0  /* DAC0/AC0 referance select bit 0 position. */
#define VREF_DAC0REFSEL1_bm  (1<<1)  /* DAC0/AC0 referance select bit 1 mask. */
#define VREF_DAC0REFSEL1_bp  1  /* DAC0/AC0 referance select bit 1 position. */
#define VREF_DAC0REFSEL2_bm  (1<<2)  /* DAC0/AC0 referance select bit 2 mask. */
#define VREF_DAC0REFSEL2_bp  2  /* DAC0/AC0 referance select bit 2 position. */
#define VREF_ADC0REFSEL_gm  0x70  /* ADC0 referance select group mask. */
#define VREF_ADC0REFSEL_gp  4  /* ADC0 referance select group position. */
#define VREF_ADC0REFSEL0_bm  (1<<4)  /* ADC0 referance select bit 0 mask. */
#define VREF_ADC0REFSEL0_bp  4  /* ADC0 referance select bit 0 position. */
#define VREF_ADC0REFSEL1_bm  (1<<5)  /* ADC0 referance select bit 1 mask. */
#define VREF_ADC0REFSEL1_bp  5  /* ADC0 referance select bit 1 position. */
#define VREF_ADC0REFSEL2_bm  (1<<6)  /* ADC0 referance select bit 2 mask. */
#define VREF_ADC0REFSEL2_bp  6  /* ADC0 referance select bit 2 position. */

/* VREF.CTRLB  bit masks and bit positions */
#define VREF_DAC0REFEN_bm  0x01  /* DAC0/AC0 referance enable bit mask. */
#define VREF_DAC0REFEN_bp  0  /* DAC0/AC0 referance enable bit position. */
#define VREF_ADC0REFEN_bm  0x02  /* ADC0 referance enable bit mask. */
#define VREF_ADC0REFEN_bp  1  /* ADC0 referance enable bit position. */
